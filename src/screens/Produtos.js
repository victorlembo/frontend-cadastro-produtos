      ...
      <View style={{ flex: 1, paddingVertical: 0, paddingHorizontal: 0 }}>
        ...
        >
          ...
          <TextInput
            ...
            onChangeText={(text) =>
              setProduto({ ...produto, codigo_produto: text })
            }
          />
          ...
          <TextInput
            ...
            onChangeText={(text) =>
              setProduto({ ...produto, nome_produto: text })
            }
          />
          <Text style={{ color: colors.text, paddingLeft: 8 }}>
          ...
          <TextInput
            ...
            onChangeText={(text) =>
              setProduto({ ...produto, descricao_produto: text })
            }
          />
          <Text style={{ color: colors.text, paddingLeft: 8 }}>
            Valor do Produto
          ...
          <TextInput
            ...
            onChangeText={(text) =>
              setProduto({ ...produto, valor_produto: text })
            }
          />
